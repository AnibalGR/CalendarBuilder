                        ...
                        <div class="col-xs-10 sb-content">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="home">
                                    <div class="layoutExample"></div>
                                    <div class="layoutExample"></div>
                                    <div class="layoutExample"></div>
                                    <div class="layoutExample"></div>
                                    <div class="layoutExample"></div>
                                    <button id="showTopLayout" type="button" class="btn btn-primary">Top layout</button>
                                    <button id="showBottomLayout" type="button" class="btn btn-success">Bottom layout</button>
                                    <button id="noneLayout" type="button" class="btn btn-danger">None layout</button>
                                    <button id="showLeftLayout" type="button" class="btn btn-success">Left layout</button>
                                    <button id="showRightLayout" type="button" class="btn btn-success">Right layout</button>
                                </div>
...
<script>
    $(document).ready(function() {
        ...
        var x = $('#calendarPanel').height();
        $('#toolsPanel').css('height', x);
    });
</script>
